 ...
 * @author ybo
 * 
 * This interface specifies what needs to be implemented to allow a PMachine to
 * output some integer data.
 */
public interface PWriter {

	/**
	 * @param data
	 *            the data to be output. \pre data is not null. \post data has
	 *            been output
	 */
