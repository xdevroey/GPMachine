...
public class PInstructionNull extends PInstructionAbstract {

	private String payload = "";

	public PInstructionNull() {
	}

	public PInstructionNull(String payload) {
	...
	public void execute(PMachine pm) throws RuntimeException {
		// It does nothing (Null Object design pattern)
	}
