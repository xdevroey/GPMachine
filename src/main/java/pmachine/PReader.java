 ...
 * @author ybo
 * 
 * This interface defines how a PMachine can read input from a user.
 */
public interface PReader {

	/**
	 * @return a StackElemInt input by the user.
	 * @throws WrongTypeException
	 *             if the user typed in a wrong value.
	 */
