 ...
 */
public class SimpleCRT implements PReader, PWriter {

    BufferedReader br = new BufferedReader(new InputStreamReader(System.in));

    public void write(StackElemInt s) {
        System.out.println(Messages.getString("SimpleCRT.WriteTextOutput") + s
                + "\n");
    }

    public StackElemInt read() throws WrongTypeException {
        try {
            System.out.print(Messages.getString("SimpleCRT.ReadTextOutput"));
            int lg = Integer.parseInt(br.readLine());
            return new StackElemInt(lg);
        } catch (Exception e) {
            throw new WrongTypeException(Messages
                    .getString("SimpleCRT.InputException"));
        }
    }
